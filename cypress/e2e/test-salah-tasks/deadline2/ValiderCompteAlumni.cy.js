describe("Valider Compte Alumni Scenario", () => {
  ...
  it("Valider un compte Alumni", () => {
    ...
    let unverifiedAccounts = mockData.filter(
      (account) => account.verified === null
    );
    ...
    let refusedAccounts = mockData.filter(
    ...
    cy.intercept(
      "GET",
      `http://localhost:3000/etudiant-alumni/${unverifiedAccounts[randomIndex].EtudiantAluId}`,
      {
        statusCode: 200,
        body: {
          ...
          dateObtentionDiplome:
            unverifiedAccounts[randomIndex].dateObtentionDiplome,
    ...
    cy.wait(5000);
    cy.contains(
      unverifiedAccounts[randomIndex].prenom +
        " " +
        unverifiedAccounts[randomIndex].nom
    );
    cy.contains("Email")
      .next()
      .should("contain", unverifiedAccounts[randomIndex].email);
    cy.contains("Date De Naissance")
      .next()
      .should("contain", unverifiedAccounts[randomIndex].dateNaissance);
    cy.contains("Formation")
      .next()
      .should("contain", unverifiedAccounts[randomIndex].formation);
    cy.contains("Poste")
      .next()
      .should("contain", unverifiedAccounts[randomIndex].poste);
    cy.contains("Date Obtention Diplome")
      .next()
      .should("contain", unverifiedAccounts[randomIndex].dateObtentionDiplome);
    cy.contains("Date Embauche")
      .next()
      .should("contain", unverifiedAccounts[randomIndex].dateEmbacuhe);
    cy.contains("Valider");
    cy.contains("Refuser");

    cy.intercept(
      "PUT",
      `http://localhost:3000/etudiant-alumni/valider/${unverifiedAccounts[randomIndex].EtudiantAluId}`,
      {
        statusCode: 200,
      }
    ).as("validateAccount");
    ...
    let indexx = mockData.findIndex(
      (etudiant) =>
        etudiant.EtudiantAluId === unverifiedAccounts[randomIndex].EtudiantAluId
    );
  ...
  it("refuser un compte Alumni", () => {
    ...
    cy.intercept(
      "PUT",
      `http://localhost:3000/etudiant-alumni/refuser/${unverifiedAccounts[randomIndex].EtudiantAluId}`,
      {
        statusCode: 200,
      }
    ).as("validateAccount");
